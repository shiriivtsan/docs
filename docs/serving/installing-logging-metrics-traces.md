...
[Accessing Metrics](../accessing-metrics/) for more information about metrics
in Knative.
...
See [Accessing Logs](../accessing-logs/) for more information about logs in
Knative.
...
1.  Choose a container image that meets the
    [Fluentd image requirements](fluentd/#requirements). For example,
...
See [Accessing Logs](../accessing-logs/) for more information about
logs in Knative.
...
Visit [Accessing Traces](../accessing-traces/) for more information on end to
end traces.
